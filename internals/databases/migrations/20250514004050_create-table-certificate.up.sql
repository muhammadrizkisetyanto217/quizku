CREATE TABLE IF NOT EXISTS user_certificates (
    ...
    user_cert_subcategory_id INTEGER NOT NULL REFERENCES subcategories(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS certificate_versions (
    ...
    cert_versions_subcategory_id INTEGER NOT NULL REFERENCES subcategories(id) ON DELETE CASCADE,
